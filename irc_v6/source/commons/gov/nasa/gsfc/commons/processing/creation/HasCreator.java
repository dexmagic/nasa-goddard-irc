...
//	
//	Revision 1.5  2004/06/02 22:33:27  chostetter_cvs
//	Namespace revisions
//	
...
import gov.nasa.gsfc.commons.numerics.time.HasTimeStamp;
import gov.nasa.gsfc.commons.types.namespaces.MemberId;


/**
 *  The HasCreator interface specifies the methods that all Objects having
 *  a Creator must implement.
 *
...
public interface HasCreator extends HasTimeStamp
{
	/**
	 *  Returns the MemberId of the creator of this created Object.
	 *
	 *  @return	The MemberId of the creator of this created Object
	**/
