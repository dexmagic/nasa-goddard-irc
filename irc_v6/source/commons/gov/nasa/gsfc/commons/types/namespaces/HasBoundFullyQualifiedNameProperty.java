...
//--- Development History:
//
//	$Log: HasBoundFullyQualifiedNameProperty.java,v $
...
/**
 *  The HasBoundFullyQualifiedNameProperty is implemented by all beans that 
 *  have a bound fully-qualified name property.
 *
...
public interface HasBoundFullyQualifiedNameProperty extends HasFullyQualifiedName
{
	public static final String FULLY_QUALIFIED_NAME_PROPERTY = 
		"Fully-Qualified Name";
	
	
	/**
	 * Adds the given PropertyChangeListener as a listener for changes in the 
	 * fully-qualified name of this bean.
	 *
