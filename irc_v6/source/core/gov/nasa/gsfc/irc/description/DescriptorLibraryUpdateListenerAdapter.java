...
//--- Development History  ---------------------------------------------------
//
//  $Log: DescriptorLibraryUpdateListenerAdapter.java,v $
...
/**
 *	A DescriptorLibraryUpdateListenerAdapter provides default implementations of the 
 *  methods of the DescriptorLibraryUpdateListener interface and is most useful for 
 *  those interested in only a subset of the update notices from the library.
 *	
...
**/
public class DescriptorLibraryUpdateListenerAdapter 
	implements DescriptorLibraryUpdateListener
{
	/**
