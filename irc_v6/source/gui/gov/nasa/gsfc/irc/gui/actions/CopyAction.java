...
/**
 * This defines a <code>CopyAction</code> that attempts to find the focus
...
public class CopyAction extends AbstractAction
{
    ...
    /**
     * Invoked when a copy action occurs.
     */
		...
		if (target instanceof Component)
		{
			...
			while (component != null)
			{
				...
				else if (component instanceof Window)
				{
					...
					copyToClipboard(((Window) component).getFocusOwner());
					component = null;
				}
				else
				{
	...
	/**
	 * Copy the selected text in the focused component to the clipboard 
	 * if possible.
	 * @param focusedComponent component to apply copy operation on.
	 **/
	protected void copyToClipboard(Component focusedComponent)
	{
		...
		{
			((ObjectClippable) focusedComponent).copyObjects();
		}
		else
		{
			...
			while (parent != null)
			{
				...
				{
					((ObjectClippable) parent).copyObjects();
					parent = null;
				}
				else
				{
