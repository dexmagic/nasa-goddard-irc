//=== File Prolog ============================================================
//
//  $Header: /cvs/IRC/Dev/source/library/gov/nasa/gsfc/irc/library/gui/vis/plot/XyPlotRenderer.java,v 1.12 2006/05/23 16:00:35 smaher_cvs Exp $
//
...
/**
 * This class provides basic two dimensional data plotting capability.
 ...
 * 
 * @version $Date: 2006/05/23 16:00:35 $
 * @author Troy Ames
 */
public class XyPlotRenderer extends AbstractVisRenderer
{
	private static final String CLASS_NAME = XyPlotRenderer.class.getName();
	 ...
	 */
	public XyPlotRenderer(AxisModel xAxis, AxisModel yAxis)
	{
	 ...
	 */
	public XyPlotRenderer(AxisModel xAxis, AxisModel yAxis, ChannelModel channels)
	{
		super();
			...
			BasisSet basisSet)
	{
		...
		if (numSamplesIn > 0)
		{
			...
			for(int loop=firstSampleIndex;loop<lastSampleIndex;loop++) {
...
//			int numChannels = dataChannels.length;
			...
			// if we get here than some of the data is visible.
...
//					basisSet.getDataBuffer((String) dataChannels[i]);
				DataBuffer dataBuffer = 
