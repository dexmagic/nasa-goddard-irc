...
/**
 * This AxisScale provides the means to convert a value to a linear scale and 
 ...
 * @author 	Troy Ames
 */
public class LinearScale implements AxisScale
{

	/**
	 * Construct a linearScale.
	 */
	public LinearScale()
	{
		super();
	...
	/**
	 * Applies a linear scale to the value and returns a ratio of where the
	 * given value is relative to the view minimum and in units the size of the
	 * view extent.
	 * <p>
	 * For example, with a linear scale and the minimum = 100 and the extent =
	 * 100, this method will return 0.5 for a value of 150, 1.0 for a value of
	 * 200, and -0.5 for a value of 50.
	 * 
	...
	{
		double scaledRatio = (value - viewMin) / extent;
		
		return scaledRatio;
	}

	/**
	 * Determines for a linear scale what value would result in the given ratio
	 * relative to the view minimum and in units the size of the view extent. 
	 * This is the inverse of <code>getScaleRatio</code>
	 * and is necessary when translating from a screen relative coordinate to an
	 * axis domain value.
	 * <p>
	 * For example, with a minimum = 100 and the extent = 100, this method will
	 * return 150.0 for a ratio of 0.5, 200.0 for a ratio of 1.0, and 50 for a
	 * ratio of -0.5.
	 * 
	...
	{
		double scaledValue = (extent * ratio) + viewMin;
...
//--- Development History  ---------------------------------------------------
//
//  $Log: LinearScale.java,v $
//  Revision 1.4  2005/10/11 03:15:00  tames
//  Reflects changes to the AxisScale interface.
//
//  Revision 1.3  2005/09/23 20:43:00  tames
