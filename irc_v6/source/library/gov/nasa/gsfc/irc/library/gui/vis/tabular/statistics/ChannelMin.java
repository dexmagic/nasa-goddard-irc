...
/**
 * ChannelMin returns the minimum value contained in the current 
 ...
 * @author 	Troy Ames
 */
public class ChannelMin extends AbstractStatisticsColumn
{
	private static final String NAME = "Min";

	/**
	 * Constructs a ChannelMin with a result class of <code>Double</code>.
	 */
	public ChannelMin()
	{
		super();
	...
	/**
	 * Returns the minimum value of the data buffer for this channel.
	 * 
	...
	{
		return new Double(dataBuffer.getMinValue());
	}
}
