...
/**
 * ChannelUnit returns the units of the current buffer for the channel. 
 *
 ...
 * @author 	Troy Ames
 */
public class ChannelUnit extends AbstractStatisticsColumn
{
	private static final String NAME = "Unit";

	/**
	 * Constructs a ChannelUnit with a result class of <code>String</code>.
	 */
	public ChannelUnit()
	{
		super();
	...
	/**
	 * Returns the units of the data buffer for this channel.
	 * 
