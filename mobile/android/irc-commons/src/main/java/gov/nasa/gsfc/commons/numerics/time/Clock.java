//=== File Prolog ============================================================
//
//  $Header: /cvs/IRCv6/Dev/source/commons/gov/nasa/gsfc/commons/numerics/time/Clock.java,v 1.2 2004/07/12 14:26:24 chostetter_cvs Exp $
//
...
/**
 *	A Clock returns various representations of time elapsed from an origin.
 *
...
public interface Clock
{
	...
	**/
	...
	/**
	 *  Returns the current time of this Clock in milliseconds.
	 *
