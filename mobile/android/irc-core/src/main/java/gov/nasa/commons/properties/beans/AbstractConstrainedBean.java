...
public abstract class AbstractConstrainedBean extends AbstractBoundBean 
	implements ConstrainedBean
{
	private transient VetoableChangeSupport fListeners;
	...
	{
		fListeners = new VetoableChangeSupport(this);
	}
	...
	{
		AbstractConstrainedBean clone = (AbstractConstrainedBean) super.clone();
	...
	{
		fListeners.addVetoableChangeListener(listener);
	}
	...
	{
		fListeners.removeVetoableChangeListener(listener);
	}
	...
	{
		fListeners.addVetoableChangeListener(propertyName, listener);
	}
	...
	public void removeVetoableChangeListener
		(String propertyName, VetoableChangeListener listener)
	{
		fListeners.removeVetoableChangeListener(propertyName, listener);
	}
	...
	{
		return (fListeners.getVetoableChangeListeners());
	}
	...
	{
		fListeners.fireVetoableChange(event);
	...
	public void fireVetoableChange(String propertyName, Object oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, oldValue, newValue);
	...
	public void fireVetoableChange(String propertyName, byte oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Byte(oldValue), 
			new Byte(newValue));
	...
	public void fireVetoableChange(String propertyName, char oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Character(oldValue), 
	...
	public void fireVetoableChange(String propertyName, short oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Short(oldValue), 
			new Short(newValue));
	...
	public void fireVetoableChange(String propertyName, long oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Long(oldValue), 
			new Long(newValue));
	...
	public void fireVetoableChange(String propertyName, float oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Float(oldValue), 
			new Float(newValue));
	...
	public void fireVetoableChange(String propertyName, double oldValue, 
		...
		throws PropertyVetoException
	{
		fListeners.fireVetoableChange(propertyName, new Double(oldValue), 
			new Double(newValue));
