...
import gov.nasa.gsfc.commons.properties.beans.ConstrainedBean;
...
public interface NamedBean extends ConstrainedBean, HasConstrainedNameProperty 
{
	/**
	 ...
	 * and a PropertyVetoException is thrown. Otherwise, the change is reported to 
	 * any name property change listeners.
	 *
	 * @param name The new name of this NamedBean
	 * @throws PropertyVetoChange if the attempted name change is vetoed
	 **/
