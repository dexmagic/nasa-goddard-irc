...
/**
 * A BeanEncoder is used to store bean properties to a stream (file).
 * 
...
{
    /**
     * Encode the object to the output stream provide to {@link BeanPersistenceFactory}.
     * 
