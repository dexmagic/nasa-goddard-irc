...
//--- Development History:
//
//	$Log: HasConstrainedFullyQualifiedNameProperty.java,v $
...
/**
 *  The HasConstrainedFullyQualifiedNameProperty is implemented by all beans 
 *  that have a constrained fully-qualified name property.
 *
...
public interface HasConstrainedFullyQualifiedNameProperty 
	extends HasBoundFullyQualifiedNameProperty
{
	/**
