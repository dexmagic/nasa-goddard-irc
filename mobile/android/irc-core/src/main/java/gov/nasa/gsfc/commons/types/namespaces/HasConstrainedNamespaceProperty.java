...
//--- Development History:
//
//	$Log: HasConstrainedNamespaceProperty.java,v $
...
/**
 *  The HasConstrainedNamespaceProperty is implemented by all beans that have a 
 *  constrained namespace property.
 *
...
public interface HasConstrainedNamespaceProperty 
	extends HasBoundNamespaceProperty
{
	/**
	 * Adds the given VetoableChangeListener as a listener for changes in the 
	 * namespace of this bean.
	 *
