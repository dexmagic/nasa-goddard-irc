...
/**
 * An OutputDescriptor is a Descriptor of an Output.
 *
...
{
	/**
	 * Constructs a new OutputDescriptor having the given parent Descriptor and 
	 * belonging to the given DescriptorDirectory by unmarshalling from the given 
	 * JDOM Element.
	 *
	 * @param parent The parent Descriptor of the new OutputDescriptor (if any)
	 * @param directory The DescriptorDirectory to which the new OutputDescriptor 
	 * 		will belong
	 * @param element The JDOM Element from which to unmarshall the new 
	 * 		OutputDescriptor		
	**/
	
	public OutputDescriptor(Descriptor parent, DescriptorDirectory directory, 
		Element element)
	{
	...
	/**
	 * Constructs a new OutputDescriptor having the given name.
	 *
	 * @param The name of the new OutputDescriptor
	**/
	
	public OutputDescriptor(String name)
	{
		super(name);
	}
}
