//=== File Prolog ============================================================
//
//  $Header: /cvs/IRC/Dev/source/core/gov/nasa/gsfc/irc/data/transformation/DataTransformerFactory.java,v 1.2 2006/05/03 23:20:16 chostetter_cvs Exp $
//
...
//--- Development History  ---------------------------------------------------
//
//  $Log: DataTransformerFactory.java,v $
...
public interface DataTransformerFactory
{
	 ...
	 *  
	 *  @param A DataTransformerDescriptor describing the desired data transformer
	 *  @return A DataTransformer appropriate to the given DataTransformerDescriptor
	 */
	
	public DataTransformer getDataTransformer(DataTransformationDescriptor descriptor);
}
