...
//--- Development History  ---------------------------------------------------
//
//  $Log: DefaultDataLoggerDescriptor.java,v $
...
public class DefaultDataLoggerDescriptor extends AbstractDataLoggerDescriptor
{
	/**
	 * Constructs a new DefaultDataLoggerDescriptor having the given parent 
	 * Descriptor and belonging to the given DescriptorDirectory by unmarshalling 
	 * from the given JDOM Element.
	 *
	 * @param parent The parent Descriptor of the new DefaultDataLoggerDescriptor 
	 * 		(if any)
	 * @param directory The DescriptorDirectory to which the new 
	 * 		DefaultDataLoggerDescriptor will belong
	 * @param element The JDOM Element from which to unmarshall the new 
	 * 		DefaultDataLoggerDescriptor		
	**/
	
	public DefaultDataLoggerDescriptor(Descriptor parent, 
