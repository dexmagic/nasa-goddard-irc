...
//--- Development History  ---------------------------------------------------
//
//  $Log: DefaultDataTransformerDescriptor.java,v $
...
/**
 * A DataTransformerDescriptor describes a transformer of data.
 *
...
public class DefaultDataTransformerDescriptor 
	extends AbstractDataTransformerDescriptor
{
	/**
	 * Constructs a new DefaultDataTransformerDescriptor having the given parent 
	 ...
	 * 		DefaultDataTransformerDescriptor (if any)
	 * @param directory The DescriptorDirectory to which the new 
	 * 		DefaultDataTransformerDescriptor will belong
	 * @param element The JDOM Element from which to unmarshall the new 
	 * 		DefaultDataTransformerDescriptor		
	**/
	
	public DefaultDataTransformerDescriptor(Descriptor parent, 
