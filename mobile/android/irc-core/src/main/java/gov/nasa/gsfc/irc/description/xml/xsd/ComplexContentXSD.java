...
/**
 * The class provides access to information describing an XML Schema complexContent 
...
**/
public class ComplexContentXSD extends AbstractXmlDescriptor
{
	//---Variables
    private ExtensionXSD fExtension;
    

	/**
	 * Constructs a new ComplexContentXSD having the given parent Descriptor 
	 * and belonging to the given DescriptorDirectory by unmarshalling from the 
	 * given JDOM Element.
	 *
	 * @param parent The parent Descriptor of the new ComplexContentXSD 
	 * 		(if any)
	 * @param directory The DescriptorDirectory to which the new 
	 * 		ComplexContentXSD will belong
	 * @param element The JDOM Element from which to unmarshall the new 
	 * 		ComplexContentXSD		
	**/
	
	public ComplexContentXSD(Descriptor parent, DescriptorDirectory directory, 
		Element element)
	{
    ...
    /**
     * Get element's extension. 
     *
     * @return ExtensionXSD
     *            
    **/
    public ExtensionXSD getExtension()
    {
        return fExtension;
    }
    ...
    **/
    ...
    {
		//--- Load Extension 
		fExtension = (ExtensionXSD) fSerializer.loadSingleChildDescriptorElement(
				Xsd.E_EXTENSION, Xsd.C_EXTENSION, fElement, this, fDirectory);
    }
}
