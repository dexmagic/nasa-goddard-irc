...
/**
 * The class provides access to information describing an XML Schema group 
...
**/
public class GroupXSD extends AbstractXmlDescriptor
{
    private ChoiceXSD fChoice;


	/**
	 * Constructs a new GroupXSD having the given parent Descriptor 
	 * and belonging to the given DescriptorDirectory by unmarshalling from the 
	 * given JDOM Element.
	 *
	 * @param parent The parent Descriptor of the new GroupXSD 
	 * 		(if any)
	 * @param directory The DescriptorDirectory to which the new 
	 * 		GroupXSD will belong
	 * @param element The JDOM Element from which to unmarshall the new 
	 * 		GroupXSD		
	**/
	
	public GroupXSD(Descriptor parent, DescriptorDirectory directory, 
		Element element)
	{
    ...
    /**
     * Get element's choice. 
     *
     * @return ChoiceXSD
     *            
    **/
    public ChoiceXSD getChoice()
    {
        return fChoice;
    }
    ...
    **/
    private void xmlUnmarshall()
    {
        ...
        fSerializer.loadChildDescriptorElements(Xsd.E_CHOICE, tmp, Xsd.C_CHOICE,
			fElement, this, fDirectory);
		Iterator i = tmp.values().iterator();
		if (i.hasNext())
		{
			fChoice = (ChoiceXSD) i.next();
		}
    }
}
