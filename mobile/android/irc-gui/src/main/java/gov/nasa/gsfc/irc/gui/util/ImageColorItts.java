//=== File Prolog ============================================================
//
//  $Header: /cvs/IRCv6/Dev/source/gui/gov/nasa/gsfc/irc/gui/util/ImageColorItts.java,v 1.1 2004/11/15 19:42:16 tames Exp $
//
...
public class ImageColorItts
{
	...
	public static final String ITT_DIR =
		"/resources/colormaps/";
	public static final String ITT_EXTENSION = ".iasc";
    ...
    /**
	 *    Load the named intensity table from a resource file
	 *  (colormaps/<name>.iasc).
	 */
    private static float[] loadItt(String name) throws IOException
	{
		String filename = ITT_DIR + name + ITT_EXTENSION;
		BufferedReader in;
		try
		{
			in = new BufferedReader(
				new InputStreamReader(
					ImageColorItts.class.getResourceAsStream(filename)));
		}
		catch(Exception e)
		{
...
//--- Development History  ---------------------------------------------------
//
//  $Log: ImageColorItts.java,v $
//  Revision 1.1  2004/11/15 19:42:16  tames
//  Initial version
//
//
