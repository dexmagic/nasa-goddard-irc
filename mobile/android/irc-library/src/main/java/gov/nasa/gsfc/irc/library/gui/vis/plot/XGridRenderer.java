//=== File Prolog ============================================================
//
//  $Header: /cvs/IRCv6/Dev/source/library/gov/nasa/gsfc/irc/library/gui/vis/plot/XGridRenderer.java,v 1.2 2005/10/11 03:07:59 tames Exp $
//
...
/**
 * This class renders vertical grid lines on a graphics context. The placement 
 ...
 * for the Instrument Remote Control (IRC) project.
 *
 * @version	$Date: 2005/10/11 03:07:59 $
 * @author	Troy Ames
 */
public class XGridRenderer extends AbstractVisRenderer
{
	private static final String CLASS_NAME = XGridRenderer.class.getName();
	 ...
	 */
	public XGridRenderer(AxisModel model)
	{
		this(model, null);
	}
	 ...
	 */
	public XGridRenderer(AxisModel model, TickFactory factory)
	{
		super();
	...
	protected void drawGrid(Graphics2D g2d, Rectangle2D rect)
	{
       ...
       //  Figure out the position of each tick.
		for (int i = 0; i < ticks.length; i++)
		{
			...
			gridLine.setLine(tickPosition, canvasBottom, 
					tickPosition, canvasTop);
...
//--- Development History  ---------------------------------------------------
//
//  $Log: XGridRenderer.java,v $
//  Revision 1.2  2005/10/11 03:07:59  tames
