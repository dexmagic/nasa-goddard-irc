...
/**
 * ChannelSamples returns the number of samples contained in the current 
 * buffer for the channel.
 *
 * <P>This code was developed for NASA, Goddard Space Flight Center, Code 580
 * for the Instrument Remote Control (IRC) project.
 *
 * @version	$Date: 2005/07/15 19:47:42 $
 * @author 	Troy Ames
 */
public class ChannelSamples extends AbstractStatisticsColumn
{
	private static final String NAME = "Samples";

	/**
	 * Constructs a ChannelSamples with a result class of <code>Integer</code>.
	 */
	public ChannelSamples()
	{
		super();
		setName(NAME);
		setResultClass(Integer.class);
	}

	/**
	 * Returns the number of samples in the data buffer for this channel.
	 * 
	...
	{
		return new Integer(dataBuffer.getSize());
	}
}
...
//--- Development History  ---------------------------------------------------
//
//  $Log: ChannelSamples.java,v $
//  Revision 1.3  2005/07/15 19:47:42  tames
