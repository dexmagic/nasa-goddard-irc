...
/**
 * A BasisSetTcpXdrOutputAdapter is an OutputAdapter that converts a specified
 * BasisSet to an XDR form and publishes it over a TCP socket to one or more
 * client listeners. This component listens for and accepts connections from
 * clients based on the parameters in the descriptor. The format of the XDR
 * BasisSet is subject to change.
 * <p>
 * This OutputAdapter paired with a
 * {@link gov.nasa.gsfc.irc.library.ports.adapters.BasisSetXdrDecoder BasisSetTcpXdrInputAdapter}
 ...
 * component is not needed or used. Of course, any software that interprets XDR
 * can be used as a client (an example Python client is included in the IRC
 * source code).
 ...
 * @author Steve Maher
 */
public class BasisSetTcpXdrOutputAdapter extends AbstractBasisSetTcpOutputAdapter
{
	private static final String CLASS_NAME = BasisSetTcpXdrOutputAdapter.class.getName();
	private static final Logger sLogger = Logger.getLogger(CLASS_NAME);

	public static final String DEFAULT_NAME = "BasisSet TCP XDR Serializer";
	...
	public BasisSetTcpXdrOutputAdapter()
	{
		this(DEFAULT_NAME);
	}
	...
	public BasisSetTcpXdrOutputAdapter(String name)
	{
		super(name);
	}
	 ...
	 */
	public BasisSetTcpXdrOutputAdapter(OutputAdapterDescriptor descriptor)
	{
		super(descriptor);
	}
	...
	protected BasisSetTcpEncoder allocateDataSetWriter(Socket socket, String keepMode, int capacity,
			int bufferSizeBytes, String errorMessage, List inputs)
	{
		return new XdrTcpEncoder(this, socket, keepMode, capacity, bufferSizeBytes, errorMessage, inputs);
	}	
...
//--- Development History  ---------------------------------------------------
//
//  $Log: BasisSetTcpXdrOutputAdapter.java,v $
