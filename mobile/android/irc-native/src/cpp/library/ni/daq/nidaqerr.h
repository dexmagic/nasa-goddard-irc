...
#define badChanError                   -10007   /* A channel is out of range for the board type or input configuration; or ... */
...
#define badRangeError                  -10012   /* The analog input or analog output voltage range is invalid for the specified ... */
...
#define badChassisIDError              -10031   /* The specified SCXI chassis does not correspond to a configured SCXI chassis. */
...
#define badGainError                   -10080   /* The gain is invalid. */
...
#define communicationsError            -10246   /* The driver is unable to communicate with the specified external device. */
...
#define noConnectError                 -10340   /* No RTSI signal/line is connected, or the specified signal and the specified ... */
#define badConnectError                -10341   /* The RTSI signal/line cannot be connected as specified. */
...
#define unknownDeviceError             -10401   /* The specified device is not a National Instruments product, or the driver ... */
#define deviceNotFoundError            -10402   /* No device is located in the specified slot or at the specified address. */
...
#define externalMuxSupporError         -10415   /* This function does not support your DAQ device when an external multiplexer ... */
...
#define stackMemError                  -10448   /* The driver is unable to continue parsing a string input due to stack limitations. */
...
#define resourceNotReservedError       -10462   /* The specified resource has not been reserved, so the action is not allowed. */
#define muxMemFullError                -10480   /* The scan list is too large to fit into the mux-gain memory of the board. */
#define bufferNotInterleavedError      -10481   /* You must provide a single buffer of interleaved data, and the channels ... */
#define SCXIModuleNotSupportedError    -10540   /* At least one of the SCXI modules specified is not supported for the operation. */
...
#define multSetupError                 -10601   /* The specified resources have already been configured by a setup operation. */
...
#define badTrigError                   -10621   /* The specified trigger signal cannot be assigned to the trigger resource. */
...
#define chanClockDisabledError         -10692   /* The acquisition cannot be started because the channel clock is disabled. */
#define extScanClockError              -10693   /* You cannot use an external scan clock when doing a single scan of a single ... */
#define unsafeSamplingFreqError        -10694   /* The sample frequency exceeds the safe maximum rate for the hardware, gains, ... */
...
#define outputTypeMustBeVoltageError   -10781   /* The polarity of the output channel cannot be bipolar when outputting currents. */
...
#define LPTcommunicationError          -10808   /* An error occurred in the parallel port communication with the DAQ device. */
#define gateSignalError                -10809   /* Attempted to start a pulse width measurement with the pulse in the phase ... */
#define internalDriverError            -10840   /* An unexpected error occurred inside the driver when performing this given ... */
...
#define underFlowError                 -10843   /* Because of system limitations, the driver could not write data to the ... */
#define underWriteError                -10844   /* New data was not written to the output transfer buffer before the driver ... */
#define overFlowError                  -10845   /* Because of system limitations, the driver could not read data from the ... */
#define overWriteError                 -10846   /* The driver wrote new data into the input transfer buffer before the previously ... */
...
#define invalidResetSignatureError     -10942   /* An invalid reset signature was sent from the host to the Remote SCXI unit. */
